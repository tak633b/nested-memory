...
Importance scoring guide — CRITICAL: avoid inflation, use the FULL range:
- 0.1-0.4: trivial, filler, greetings, acknowledgements, small talk
- 0.5-0.6: DEFAULT for general conversation, routine information, status updates
- 0.7-0.8: decisions, discoveries, preferences, project updates, notable events
- 0.9-1.0: critical changes, major events, errors/failures, explicit "remember this"

Most memories should score 0.5-0.6. Only assign 0.8+ when clearly significant."""
